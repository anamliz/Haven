...
// Example create, update and delete operations

// Create operation
newAccommodation := pollDataTypes.Accommodation{
    Name:        "Initial Name",
...
_, err = pd.Post(ctx, newAccommodation)
if err != nil {
...
err = pd.Update(ctx, 8, pollDataTypes.Accommodation{
    Name:        "Updated Name",
